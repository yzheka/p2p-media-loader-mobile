    ...
    try {
      if (this.segmentStorage.hasSegment(i, r, t.externalId)) {
        ...
        if (a) {
          ...
          return console.log(">>> resolve segment data: ", t.externalId), void o.resolve(a, this.getBandwidth(h));
        }
      }
      this.engineRequest && (console.log(">>> abort segment data: ", t.externalId), this.engineRequest.abort(), this.engineRequest = void 0), this.engineRequest = o;
    } catch {
      o.reject();
    } finally {
...
const U = class U {
  ...
  async loadSegment(t, e) {
    ...
    console.log(">>> newRequest", n.externalId), this.getStreamHybridLoader(n).loadSegment(n, e);
  }
